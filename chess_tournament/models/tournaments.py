...
class Tournament:
	...
	def from_dict(cls, tournament_dict):
		return cls(tournament_dict["name"], tournament_dict["place"], tournament_dict["time"], tournament_dict["description"])
...
class Round:
	def __init__(self, round_name, datetime_start=None, datetime_end=None, matches=None):
	...
	def to_dict(self):
		return {
			...
			'datetime_start': datetime.timestamp(self.datetime_start) if self.datetime_start else None,
			'datetime_end': datetime.timestamp(self.datetime_end) if self.datetime_end else None,
			'matches': [m.to_dict() for m in self.matches]
		}

	@classmethod
	def from_dict(cls, tournament_dict):
		return cls(tournament_dict["round_name"], tournament_dict["datetime_start"], tournament_dict["datetime_end"])
