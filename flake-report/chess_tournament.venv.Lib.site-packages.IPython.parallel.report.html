...
<html>
   <head>
      <title>flake8 violations: .\chess_tournament\venv\Lib\site-packages\IPython\parallel.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="chess_tournament.venv.Lib.site-packages.IPython.parallel.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .\chess_tournament\venv\Lib\site-packages\IPython\parallel.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="chess_tournament.venv.Lib.site-packages.IPython.parallel.source.html#l20">
                  <tt><i>20</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
