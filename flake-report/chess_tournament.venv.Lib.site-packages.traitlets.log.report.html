...
<html>
   <head>
      <title>flake8 violations: .\chess_tournament\venv\Lib\site-packages\traitlets\log.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="chess_tournament.venv.Lib.site-packages.traitlets.log.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .\chess_tournament\venv\Lib\site-packages\traitlets\log.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="chess_tournament.venv.Lib.site-packages.traitlets.log.source.html#l10">
                  <tt><i>10</i> <span class="k">def</span> <span class="nf">get_logger</span><span class="p">():</span></tt>
               </a>
            </li>
            </ul>
         </li>
